...
class RegisterPage:
    def __init__(self, page: Page):
        ...
        # create account
        self.create_acc_btn = page.locator("//button[@data-qa='create-account']")
    ...
    def create_account(self):
        self.create_acc_btn.scroll_into_view_if_needed()
        expect(self.create_acc_btn).to_be_visible()
        expect(self.create_acc_btn).to_be_enabled()
    ...
    def continue_account(self):
        ...
        self.continue_btn.wait_for(state="visible")
